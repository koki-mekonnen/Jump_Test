...
config :markdown_editor, MarkdownEditorWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "RUz2bLVUl9MxpTznHXjZj4QZV45zbkCEdrFYYntPZn8MyRd+GiQBBam6XwStAszw",
  watchers: [
...
config :markdown_editor, MarkdownEditorWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/markdown_editor_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :markdown_editor, dev_routes: true
